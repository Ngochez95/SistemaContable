 ...
 * @author Atato
 */
public class CtrVistaPrincipal implements ActionListener{

    VistaPrincipal vista;
    ModeloRespaldo modelo = new ModeloRespaldo();
    ...
    public CtrVistaPrincipal(VistaPrincipal vista) {
        this.vista = vista;        

        //Ocultar el Boton de "Respaldo"
        vista.getBtnRespaldar().setVisible(true);
